...
public class Soldier implements Serializable {
  ...
  private String militaryNumber; // 병력 번호 필드 추가
  ...
  public LocalDate getEnlis_date() {
    return enlistmentDate;
  }

  public void setEnlis_date(LocalDate enlistmentDate) {
    this.enlistmentDate = enlistmentDate;
  }
  ...
  public void setDis_date(LocalDate dischargeDate) {
    this.dischargeDate = dischargeDate;
  }
  ...
  public void setD_day(long dDay) {
    this.dDay = dDay;
  }
}

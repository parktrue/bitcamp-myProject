...
<head>
  <meta charset='UTF-8'>
  <title>인사정보체계</title>
  <link rel="stylesheet" href="../../../css/soldier/detail.css">
  ...
  <c:if test="${not empty soldier}">
    <form action='update' method='post' enctype='multipart/form-data'>
      <table border='1'>
        ...
        <tr>
          <th>군번</th>
          <td><input type='text' name='militaryNumber' value=${soldier.militaryNumber} readonly></td>
        </tr>
        ...
        <tr>
          ...
          <td>${soldier.enlistmentDate}</td>
            <%--          <td><input type='date' name='enlistmentDate' value=${soldier.enlistmentDate} readonly></td>--%>
        </tr>
        <tr>
          <th>전역일</th>
          <td>${soldier.dischargeDate}</td>
            <%--          <td><input type='date' name='dischargeDate' value=${soldier.dischargeDate} readonly></td>--%>
        </tr>
        <tr>
          <th>D-Day</th>
          <td>${soldier.dDay}</td>
